	...
	getDeepLink() {
		...
		if ( this.isAndroid() ) {
			switch ( currentSection ) {
				case EDITOR:
					return `intent://editor/?siteId=${ siteId }&postId=${ postId }` +
						'#Intent;scheme=wordpress;package=org.wordpress.android;end';
				case NOTES:
					return `intent://viewnotifications/?notificationId=${ notificationId }` +
						'#Intent;scheme=wordpress;package=org.wordpress.android;end';
				case READER:
					return `intent://viewpost/?blogId=${ siteId }&postId=${ postId }` +
						'#Intent;scheme=wordpress;package=org.wordpress.android;end';
				case STATS:
